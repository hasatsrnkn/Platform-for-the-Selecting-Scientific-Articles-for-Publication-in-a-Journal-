...
const VicePresidentBestPapers = (props) => {
  ...
  useEffect(() => {
    const fetchAllPapers = async () => {
      console.log(API_SORT_BEST_PAPERS);
      ...
      try {
        const response = await fetch(API_SORT_BEST_PAPERS, {
          method: "GET",
          headers: {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <Row>
        <SectionBestPaperList page={page} papers={papers}></SectionBestPaperList>
      </Row>
...
export default VicePresidentBestPapers;
