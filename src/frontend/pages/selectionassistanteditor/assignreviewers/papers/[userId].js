...
import { API_GET_ALL_REVIEWERS } from "../../../api/api";
import AssignPapersToReviewers from "../../../../components/AssignPapersToReviewers/AssignPapersToReviewers";

const AssignPapersPage = (props) => {
  ...
  useEffect(() => {
    const fetchAllReviewers = async () => {
      console.log(API_GET_ALL_REVIEWERS);
      ...
      try {
        const response = await fetch(API_GET_ALL_REVIEWERS, {
          method: "GET",
          headers: {
